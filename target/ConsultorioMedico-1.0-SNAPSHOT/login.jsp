    ...
    <div class="form-container">
       ...
       <form action="SrvLogin" method="POST">
            <div class="group-material-login">
                <input id="usuario" name="usuario" type="text" class="material-login-control" required="" maxlength="70">
              <span class="highlight-login"></span>
              <span class="bar-login"></span>
              <label><i class="zmdi zmdi-account"></i> &nbsp; Nombres</label>
            </div><br>
            <div class="group-material-login">
                <input id="contrasenia" name="contrasenia"type="password" class="material-login-control" required="" maxlength="70">
              <span class="highlight-login"></span>
              <span class="bar-login"></span>
            ...
            <div class="group-material">
                <select class="material-control-login">
                    ...
                    <option value="Teacher">Asistente</option>
                    <option value="Personal">Personal de Soporte Técnico</option>
