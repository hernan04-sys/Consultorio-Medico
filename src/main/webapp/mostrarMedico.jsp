<%-- 
    Document   : mostrarMedico
    Created on : 25 jul 2024, 13:36:42
...
<%@include file="Componentes/header.jsp"%>
    <title>Mostrar Médico</title>
<%@include file="Componentes/header2.jsp"%>
<%@include file="Componentes/body1.jsp"%>

<div class="container">
    <div class="page-header">
        <h1 class="all-tittles">Listado de Médicos <small>visualización de médicos</small></h1>
    </div>
</div>
    ...
    <div class="container-fluid" style="margin: 50px 0;">
        <div class="row">
            <div class="col-xs-12 col-sm-4 col-md-3">
                <img src="assets/img/verdoc.png" alt="user" class="img-responsive center-box" style="max-width: 110px;">
            </div>
            <div class="col-xs-12 col-sm-8 col-md-8 text-justify lead">
                Bienvenido a la sección donde se encuentra el listado de Médicos, aquí también puedes actualizar o eliminar los datos del Médico.
            </div>
        </div>
    </div>
    <div class="container-fluid">
        <div class="row">
            <div class="col-xs-12 lead">
                <ol class="breadcrumb">
                    <li class="active">Listado de Médicos</li>
                </ol>
            </div>
        </div>
    </div>
    <div class="container-fluid">
        <h2 class="text-center all-tittles">listado de médicos</h2>
        <div class="div-table">
            <div class="div-table-row div-table-head">
                ...
                <div class="div-table-cell">Especialidad</div>
                <div class="div-table-cell">Actualizar</div>
                <div class="div-table-cell">Eliminar</div>
            </div>
            <% 
                List<Doctor> listaMedicos = (List) request.getSession().getAttribute("listaMedicos");
                SimpleDateFormat sdf = new SimpleDateFormat("dd/MM/yyyy");
                for (Doctor doc : listaMedicos) {
                    Date fechaNacimiento = doc.getFecha_nacimiento();
                    String fechaFormateada = fechaNacimiento != null ? sdf.format(fechaNacimiento) : "N/A";
            %>
            <div class="div-table-row">
                <div class="div-table-cell" id="id_doc<%=doc.getId()%>"><%=doc.getId()%></div>
                <div class="div-table-cell"><%=doc.getNombres()%></div>
                <div class="div-table-cell"><%=doc.getApellidos()%></div>
                <div class="div-table-cell"><%=doc.getCciudadania()%></div>
                <div class="div-table-cell"><%=doc.getDireccion()%></div>
                <div class="div-table-cell"><%=doc.getTelefono()%></div>
                <div class="div-table-cell"><%=doc.getCorreo_electronico()%></div>
                <div class="div-table-cell"><%=fechaFormateada%></div>
                <div class="div-table-cell"><%=doc.getEspecialidad()%></div>
                <div class="div-table-cell">
                    <form name="actualizar" action="SrvActMedico" method="GET">
                        <button type="submit" class="btn btn-success"><i class="zmdi zmdi-refresh"></i></button>
                        <input type="hidden" name="id" value="<%=doc.getId()%>">
                    </form>
                </div>
                <div class="div-table-cell">
                    <form name="eliminar" action="SrvElimMedico" method="POST">
